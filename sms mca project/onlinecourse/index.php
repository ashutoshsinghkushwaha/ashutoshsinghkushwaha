...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4><a href="admin" style="float:right; margin-right:30px; color:red ;"> Admin Login </a> </h4>
                    <h4 class="page-head-line">Student Enter Your Detail to Login </h4>
            ...
            <form name="admin" method="post">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="regno" class="form-control" placeholder="Provided By :- admin" />
